...
public class JwtTokenUtil {
    ...
    public boolean validateToken(String token, String username) {
        try {
            System.out.println("MASUK"); // Debugging
